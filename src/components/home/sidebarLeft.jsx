  ...
  return (
    <section className="left">
      ...
      <div className="guide-render d1">
        ...
        <div className="subscribes items">
          <a href="">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
      ...
      <div className="guide-render d2">
        ...
        <div className="your-videos items">
          <a href="">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
        ...
        <div className="watch-later items">
          <a href="">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
        ...
        <div className="videos-likeds items">
          <a href="">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
      ...
      <div style={{ marginTop: "20px" }} id="line"></div>
      {/* <!-- DIV INSCRIÇÕES --> */}
      <div className="guide-render d3">
        <h3>INSCRIÇÕES</h3>
        <div className="channel">
          <a href="">
            <img
              src="https://yt3.ggpht.com/ytc/AMLnZu9SFJaGUnZnhHBfmnrSQ_5IZObGBhia1VSMVdpTEg=s88-c-k-c0x00ffffff-no-rj"
              alt=""
              srcset=""
            />
            Curso em Video
      ...
      <div id="line"></div>
      {/* <!-- DIV MAIS DO YOUTUBE --> */}
      <div className="guide-render d5">
        <h3>MAIS DO YOUTUBE</h3>
        <div className="ytPremium items">
          <a href="">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
            ...
            >
              <g className="style-scope yt-icon">
                ...
                >
                  ...
                  <g fill-rule="nonzero" className="style-scope yt-icon">
                    <path
                      fill="#F00"
